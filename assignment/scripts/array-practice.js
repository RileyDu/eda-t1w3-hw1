...
let favoriteFoods = ["pizza", "burger", "steak", "fries"];
...
console.log("Number of my favorite foods:", numberOfFoods);
...
let reversedGems = gems.sort(function (a, b) {
  return b.localeCompare(a);
});
console.log(reversedGems);
